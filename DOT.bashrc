...
# set default editor to vim or vi
...
case `uname` in
    "Darwin"|"FreeBSD")
        # Color ls and display filesystem flags
...
if [ "$color_prompt" = yes ]; then
    ...
    PS1='${debian_chroot:+($debian_chroot)}'$GIT_PROMPT'\u@\h:\w\$ '
fi
